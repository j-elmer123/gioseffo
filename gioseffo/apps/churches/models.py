...
class Church(MPTTModel):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='church_creates', on_delete=models.CASCADE)
    ...
    deleted_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='church_deletes', on_delete=models.CASCADE)
